...
2. Install the WSO2 APK Helm chart data plane only mode.
...
3. Check all pods related to the deployment are installed properly.

```bash
kubectl get pods -n apk 
```

4. Try out WSO2 APK from

[https://apk.docs.wso2.com/en/latest/get-started/quick-start-guide/](https://apk.docs.wso2.com/en/latest/get-started/quick-start-guide/)

5. To uninstall WSO2 APK, run the following command.
